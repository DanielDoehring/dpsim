		...
		namespace Ph3 {
			...
			*/
			...
			public:
				...
				void addMonitoredNodes(std::shared_ptr<Capacitor> cap, std::shared_ptr<Inductor> inductor);
				...
				public:
						...
						Task(AvVoltageSourceInverterDQ.mName + ".MnaPostStep"), mAvVoltageSourceInverterDQ(AvVoltageSourceInverterDQ), mLeftVector(leftVector)
					{
						...
						mAttributeDependencies.push_back(mAvVoltageSourceInverterDQ.mSubResistorF->attribute("i_intf"));
