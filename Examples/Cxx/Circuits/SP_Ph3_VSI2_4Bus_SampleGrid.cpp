...
int main(int argc, char* argv[]) {
	...
	Real finalTime = 0.6;
	String simName = "SP_Ph3_VSI2_4BUS_SampleGrid";
	...
	auto vsi2 = AvVoltageSourceInverterDQ::make("vsi2", Logger::Level::info);
	auto trans_DG1 = Ph3::Transformer::make("trans_pv1", Logger::Level::info);
	auto trans_DG2 = Ph3::Transformer::make("trans_pv2", Logger::Level::info);
