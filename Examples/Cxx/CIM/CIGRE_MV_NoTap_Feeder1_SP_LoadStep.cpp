...
int main(int argc, char** argv) {
	...
	String simName = "SP_noDG_FaultN2_500e-6";
	...
	//addLoadStepToSystem(stepLoad_n11, 2353, "N11", systemSP);
	...
	auto sw1 = SwitchEvent::make(7.0 - timeStep, fault_n2, true);
