...
# Simulation params
OPTS="--timestep 0.001 --duration $((200)) --system-freq 50 --start-at $TIME --solver-domain SP --solver-type MNA --log-level NONE"
echo "Simulation params: $OPTS"

CPS_LOG_PREFIX="[Sys ] " \
build/Examples/Cxx/Shmem_CIGRE_MV_Feeder1_SP_CoVeeCtrl $(pwd)/Examples/CIM/grid-data/CIGRE_MV_NoTap_Feeder1_only/*.xml \
